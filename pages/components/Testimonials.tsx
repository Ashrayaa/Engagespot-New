...
const Testimonials = (props: Props) => {
  return (
    <>
      <div className="flex flex-col justify-center items-center gap-2 -mt-36 lg:-mt-[350px] 2xl:-mt-[440px]">
        <h1 className="text-[#8B8B8B]">TESTIMONIALS</h1>
        <h1 className="text-[#E7E3E3] text-2xl px-10 text-center font-semibold">
          Love from Customers
        </h1>

        <div className="px-1 lg:grid lg:grid-flow-row lg:grid-cols-3 lg:mx-4 2xl:mx-40">
