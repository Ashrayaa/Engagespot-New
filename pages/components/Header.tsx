...
const Header = (props: Props) => {
  return (
    <>
      <div className="bg-black text flex lg:justify-between lg:items-center lg:p-4 lg:px-6 p-4 text-white lg:gap-24 2xl:justify-around xl:justify-between xl:gap-52 2xl:gap-[400px]">
        {/* LOGO */}
        <Link href="/">
